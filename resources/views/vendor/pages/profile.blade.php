                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{($vendorData->pic != '')? asset('backend/assets/vendor/'.$vendorData->pic) : asset('backend/assets/vendor/vendor.png')}}" alt="vendor" class="rounded-circle p-1 bg-primary" width="110">
                            <div class="mt-3">
