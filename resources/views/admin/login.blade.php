...
<head>
	...
	<title>Mvecommerce Admin Login</title>
</head>
						...
						<div class="card">
                          ...
                          <span>Sign in with Google</span>
									...
									<div class="form-body">
										...
										<form class="mt-3" action="{{ route('password.request') }}" method="POST">
											@csrf
											<div class="col-md-12 text-end"><button type="submit" class="btn-sm border-0 bg-white text-info">Forgot Password ?</button>
											</div>
										</form>
									</div>
								</div>
