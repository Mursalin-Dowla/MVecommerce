                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <img src="{{($adminData->pic != '')? asset('backend/assets/admin/'.$adminData->pic) : asset('backend/assets/admin/admin.png')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                            <div class="mt-3">
