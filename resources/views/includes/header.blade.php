        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img height="70px" src="{{asset('uploads/siteimage/'.$seo->logo)}}" alt="logo" /></a>
                </div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    ...
                                    <span class="pro-count blue cart_count">0</span>
                                </a>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span class="total_cart">$0</span></h4>
                                        </div>
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        <form action="{{route('logout')}}" method="post">
                                            @csrf
                                            <li>
                                                <button class="border-0 bg-white"><i class="fi fi-rs-sign-out mr-10"></i>Sign out</button>
                                            </li>
                                        </form>                                        
                                    </ul>
                                </div>
